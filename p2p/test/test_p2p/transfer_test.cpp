...
//
//        for (int i = 0; i < 2 ; ++i) {
//            transferQueue->queueTransfer(std::make_shared<SimplePathRI>(testPath / ("l" + std::to_string(i) + ".txt")),std::make_shared<SimplePathRI>(destinationPath / ("l" + std::to_string(i) + ".txt")));
//            transferQueue->queueTransfer(std::make_shared<SimplePathRI>(testPath / ("v" + std::to_string(i) + ".txt")),std::make_shared<SimplePathRI>(destinationPath / ("v" + std::to_string(i) + ".txt")));
//            transferQueue->queueTransfer(std::make_shared<SimplePathRI>(testPath / ("e" + std::to_string(i) + ".txt")),std::make_shared<SimplePathRI>(destinationPath / ("e" + std::to_string(i) + ".txt")));
//        }
//
//        transferQueue->start();
