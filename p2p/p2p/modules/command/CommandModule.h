...
namespace bsc {
    ...
    private:
        using InternalGroupHandlerFunc = std::function<GroupHandlerResult(ArgumentContainerTypeRef,
                                                                          const CommandGroup&)>;
            ...
            params) {
                ...
                mapCommand(" ", commandName,
                           [f, mod, commandName, params](CommandModule::ArgumentContainerTypeRef vals) {
                               ...
                               ParametersType localParams = bsc::CommandLineParameters::parse<ParametersType>(
                                       commandName,
                                       vals);
    ...
    public:
        ...
        void setDefaultGroupHandler(std::function<CommandExecutionStatus(const ParametersType&,
                                    const CommandModule::CommandGroup&)
